						           				...
						           				<div class="d-flex flex-row">
						                			...
						                			<div class="ml-2">
						                    			<div class="ticket-info">
						                    				<span class="mb-0">${ticket.ticketname}</span>
						                    				<span class="priceperticket" price="${ticket.ticketprice}">표당 ${ticket.ticketprice}원</span>
						                    				<span class="ticketquantityleft">${ticket.ticketremain}좌석 남음</span>
						                    			</div>   
						                			</div>
						            			</div>
						        			</li>
        ...
        <div class="modal-content">
        	<form id="reservationForm" action="/TicketMvp/reserve/ReserveConfirm.do" method='post'>
	            ...
	            <div class="modal-footer">
	                <button id="purchaseConfirm" class="btn ajaxlink">예매확인</button>
